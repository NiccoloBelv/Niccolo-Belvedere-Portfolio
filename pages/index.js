          ...
          <div className={styles.projectContainer}>
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project10'] && (
                <p><a href="Pane Quotidiano Report.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the report</a> and <a href="PQ - Presentation.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">here the presentation</a><br />
