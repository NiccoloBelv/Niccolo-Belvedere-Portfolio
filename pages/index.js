      ...
      <main className={styles.main}>
        ...
        <section id="projects" className={`${styles.projectSection} ${visibleSections.projects ? 'visible-section' : 'hidden-section'}`}>
          ...
          <div className={styles.projectContainer}>
            ...
            <div className={styles.projectItem}><strong>Master's thesis (Work in Progress): How financials and macroeconomics factors affect the volatility of personnel in Big Tech companies</strong><br />
            <br />
            </div>
              
            <div className={styles.projectItem}><strong><a href="Bachelor's Degree Thesis.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Bachelor's thesis (2022): "The key role of People in Public Administration: How Civil Service Models affect the quality of a nation" <span class="download-icon">⬇️</span></a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="Big Data Report.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Big Data for Business Decisions (2023): "Monetary Words, Market Echoes" <span class="download-icon">⬇️</span></a> & <a href="Big Data presentation.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Presentation <span class="download-icon">⬇️</span> (co-authored)</a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="Corporate Strategy Report.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Performance Measurement & Corporate Strategy (2023): How to innovate Microsoft's Corporate Strategy <span class="download-icon">⬇️</span> (co-authored)</a></strong><br /> 
            ...
            Following this, a detailed micro-level analysis of each business segment was carried out. This involved evaluating the industry attractiveness, competitive landscape, and identifying key success factors for each segment. Such an in-depth analysis offered a clearer view of the strengths, weaknesses, opportunities, and threats within Microsoft's varied business portfolio.<br /> 
            One of the report's focal points was the strategy for integrating artificial intelligence across Microsoft's business units. The analysis here was twofold: it first assessed the strategic importance of AI integration and then explored potential avenues for acquiring AI capabilities, such as through the acquisition of companies like OpenAI.<br /> 
            The report also paid close attention to Microsoft’s commitments to social and environmental sustainability, underscoring its CSR initiatives and strategies for maintaining ethical and sustainable business practices.<br /> 
            ...
            <div className={styles.projectItem}><strong><a href="Asset Management Report.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Asset Management (2023): ESG Multi-Asset Fund E2 – EUR analysis <span class="download-icon">⬇️</span> (co-authored)</a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="Financial Analysis of IVECO Group.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Financial Management & Corporate Banking (2023): Financial Analysis of IVECO Group <span class="download-icon">⬇️</span> (co-authored)</a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="Should Cash-Out mergers be available.pptx" class="download-link" target="_blank" rel="noopener noreferrer">Business Law (Advanced) (2023): "Should Cash-Out mergers be available?" <span class="download-icon">⬇️</span> (co-authored)</a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="Toyota Analysis.pdf" target="_blank" class="download-link" rel="noopener noreferrer">Performance Measurement (2022): Toyota Analysis <span class="download-icon">⬇️</span> (co-authored)</a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="Decathlon In-Company Training.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Decathlon In-Company Training (2022): "Decathlon ad impatto zero" <span class="download-icon">⬇️</span> (co-authored)</a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="Competitive Intelligence Report.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Competitive Intelligence (2022): "Impact of Volkswagen's Trinity Project on Tesla" <span class="download-icon">⬇️</span> (co-authored)</a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="The allocation of PNRR funds for the National Health Service.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Public Administration Management (2021): The allocation of PNRR funds for the National Health Service <span class="download-icon">⬇️</span> (co-authored)</a></strong><br />
            ...
            <div className={styles.projectItem}><strong><a href="Telecom Italia S.p.A. analysis.pdf" target="_blank" class="download-link" rel="noopener noreferrer">Business Administration (2019): Telecom Italia S.p.A. analysis <span class="download-icon">⬇️</span> (co-authored)</a></strong><br /> 
