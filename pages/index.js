          ...
          <div className={styles.projectContainer}>
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project2'] && (  
                <p>a href="Bachelor's Degree Thesis.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the pdf. </a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project3'] && (
                <p><a href="Big Data Report.pdf" class={styles.download-link}  target="_blank" rel="noopener noreferrer">Download here the report.</a> and <a href="Big Data presentation.pdf" class={styles.download-link}  target="_blank" rel="noopener noreferrer">here the presentation.</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project4'] && (
                <p><a href="Corporate Strategy Report.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the pdf.</a><br /> 
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project5'] && (
                <p><a href="Asset Management Report.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the pdf.</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project6'] && (
                <p><a href="Financial Analysis of IVECO Group.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the pdf.</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project7'] && (
                <p><a href="Should Cash-Out mergers be available.pptx" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the presentation.</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project8'] && (
                <p><a href="Toyota Analysis.pdf" target="_blank" class={styles.download-link} rel="noopener noreferrer">Download here the pdf.</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project9'] && (
                <p><a href="Decathlon In-Company Training.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the pdf.</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project10'] && (
                <p><strong><a href="Pane Quotidiano Report.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the report</a> and <a href="PQ - Presentation.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">here the presentation</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project11'] && (
                <p><a href="Competitive Intelligence Report.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the report.</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project12'] && (
                <p><a href="The allocation of PNRR funds for the National Health Service.pdf" class={styles.download-link} target="_blank" rel="noopener noreferrer">Download here the pdf.</a><br />
            ...
            <div className={styles.projectItem}>
              ...
              {visibleDescriptions['project13'] && (
                <p><a href="Telecom Italia S.p.A. analysis.pdf" target="_blank" class={styles.download-link} rel="noopener noreferrer">Download here the pdf.</a><br /> 
