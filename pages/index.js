        ...
        <section id="projects" className={`${styles.projectSection} ${visibleSections.projects ? 'visible-section' : 'hidden-section'}`}>
          ...
          <div className={styles.projectContainer}>
            <p>
              ...
              <strong><a href="Bachelor's Degree Thesis.pdf" class="download-link" target="_blank" rel="noopener noreferrer">Bachelor's thesis (2022): "The key role of People in Public Administration: How Civil Service Models affect the quality of a nation" <span class="download-icon">⬇️</span></a></strong><br />
